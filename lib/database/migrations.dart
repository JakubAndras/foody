...
final Migration migration11to12 = Migration(11, 12, (database) async {
  try {
    await database.execute('ALTER TABLE `Ingredient` ADD COLUMN `amount` REAL NOT NULL DEFAULT 1.0');
  } catch (_) {}
});
