  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ProfileGradientScaffold(
      ...
      child: Column(
        ...
        children: [
          ProfileTopBar(title: tr(LocaleKeys.preferences_title), onBack: () => Navigator.of(context).pop()),
          ...
          GlassSegmentedTabs(
            ...
            activeIndex: _themeIndexFromMode(session.themeMode),
            onTap: (index) {
              final mode = [ThemeMode.system, ThemeMode.light, ThemeMode.dark][index];
              sessionNotifier.setThemeMode(mode);
            },
          ),
          const SizedBox(height: AppSpacing.m),
          ProfileCard(
            ...
            child: Column(
              children: [
                ...
                GlassToggleRow(
                  ...
                  isOn: session.burnedCaloriesEnabled,
                  onChanged: (val) => sessionNotifier.setBurnedCaloriesEnabled(val),
                ),
                GlassToggleRow(
                  title: tr(LocaleKeys.preferences_rollover_calories),
                  subtitle: tr(LocaleKeys.preferences_rollover_calories_desc),
                  isOn: session.rolloverCaloriesEnabled,
                  onChanged: (val) => sessionNotifier.setRolloverCaloriesEnabled(val),
                ),
                GlassToggleRow(
                  title: tr(LocaleKeys.preferences_auto_adjust),
                  subtitle: tr(LocaleKeys.preferences_auto_adjust_desc),
                  isOn: session.autoAdjustMacrosEnabled,
                  onChanged: (val) => sessionNotifier.setAutoAdjustMacrosEnabled(val),
                ),
                GlassToggleRow(
                  title: tr(LocaleKeys.preferences_save_photos_gallery),
                  subtitle: tr(LocaleKeys.preferences_save_photos_gallery_desc),
                  isOn: session.savePhotosToGallery,
                  onChanged: (val) => sessionNotifier.setSavePhotosToGallery(val),
                  showDivider: false,
                ),
              ],
            ),
