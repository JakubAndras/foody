      ...
      child: Column(
        ...
        children: [
          ...
          Center(
            child: Column(
              children: [
                Text(tr(LocaleKeys.onboarding_weight_loss_speed_per_week), style: textTheme.bodyLarge?.copyWith(color: AppColors.textSecondary)),
            ...
            children: [
              ...
              Expanded(
                child: GlassSlider(
                  ...
                  thumbRadius: 18,
                  onChanged: (value) {
                    final snapped = ((value * 10).round() / 10).clamp(_minSpeedKgPerWeek, _maxSpeedKgPerWeek);
          ...
          if ((_value - _recommendedSpeedFromWeightKg(SessionManager.to.weightKg.value)).abs() > 0.05)
            Center(
              child: Material(
