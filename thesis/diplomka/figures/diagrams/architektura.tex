...
\draw[arr, <->] (client.south -| sqlite.north) -- (sqlite.north)
	node[pos=0.5, right=1mm, font=\scriptsize\sffamily] {DAO (SQL)};
...
\draw[arr] (svc.east) -- (svc.east -| busTop) -- (busOpenai) -- (openai.west);
\draw[arrInactive] (svc.east) -- (svc.east -| busTop) -- (busGemini) -- (gemini.west);
\draw[arr] (svc.east) -- (svc.east -| busTop) -- (busOff)    -- (off.west);
