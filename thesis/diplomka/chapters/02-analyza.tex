...
Účastníci uživatelské studie jsou v~textu označováni \texttt{R1}--\texttt{R4} (Respondent rozhovorů).
Tři ze čtyř respondentů, konkrétně R1, R2 a~R3, byli později zařazeni i do uživatelského testování implementované aplikace jako participanti \texttt{P1}, \texttt{P2} a~\texttt{P3} (kapitola~\ref{ch:testovani}), čímž je mezi analytickou a evaluační fází práce zachována kontinuita.
