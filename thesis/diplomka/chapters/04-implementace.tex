...
Transakční entity tvoří dvouúrovňovou hierarchii s~\texttt{DayRecord} v~kořeni: \texttt{Meal} je k~dennímu záznamu připojeno vztahem 1:N, \texttt{Ingredient} je obdobně připojena k~\texttt{Meal}, a \texttt{Exercise} tvoří paralelní podstrom přímo pod \texttt{DayRecord}.
